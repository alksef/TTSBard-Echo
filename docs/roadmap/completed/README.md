...
- [013 — Один экземпляр и повторный запуск](013-single-instance-launch.md) — добавил ранний Windows guard и возврат существующего главного окна, чтобы повторный запуск не создавал вторые настройки и SSE-подключения.
- [014 — Выход из приложения в сайдбаре](014-sidebar-exit-action.md) — перенёс полное завершение из заголовка в footer сайдбара, чтобы оконные кнопки и lifecycle приложения были разделены явно.
- [015 — Стабильный размер floating и очистка основного UI](015-floating-resize-and-diagnostics-ui.md) — закрепил контентную высоту native-ограничениями и убрал служебный экспорт из панели подключений, чтобы floating не дёргался, а основной UI оставался минимальным.
- [016 — Заголовок и сворачивание главного окна](016-main-window-minimize-lifecycle.md) — убрал крестик и добавил выключенное по умолчанию скрытие при сворачивании, чтобы обычное окно оставалось на панели задач.
